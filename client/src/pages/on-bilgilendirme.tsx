...
export default function OnBilgilendirme() {
  ...
  const content = {
    tr: {
      ...
      withdrawalNoticeText: "Cayma hakkınızı kullanmak için 14 gün içinde info@089bayern.com adresine e-posta göndererek veya +90 507 192 2036 / +49 155 68855141 numarasını arayarak bildirimde bulunabilirsiniz.",
    ...
    de: {
      ...
      withdrawalNoticeText: "Um Ihr Widerrufsrecht auszuüben, können Sie innerhalb von 14 Tagen eine E-Mail an info@089bayern.com senden oder unter +90 507 192 2036 / +49 155 68855141 anrufen.",
    ...
    en: {
      ...
      withdrawalNoticeText: "To exercise your right of withdrawal, you can send an email to info@089bayern.com or call +90 507 192 2036 / +49 155 68855141 within 14 days.",
    ...
    ru: {
      ...
      withdrawalNoticeText: "Для осуществления права на отказ вы можете отправить электронное письмо на info@089bayern.com или позвонить по телефону +90 507 192 2036 / +49 155 68855141 в течение 14 дней.",
    ...
    uk: {
      ...
      withdrawalNoticeText: "Для здійснення права на відмову ви можете надіслати електронного листа на info@089bayern.com або зателефонувати за номером +90 507 192 2036 / +49 155 68855141 протягом 14 днів.",
    ...
    ar: {
      ...
      withdrawalNoticeText: "لممارسة حق الانسحاب، يمكنك إرسال بريد إلكتروني إلى info@089bayern.com أو الاتصال على +90 507 192 2036 / +49 155 68855141 خلال 14 يوماً.",
    ...
    hr: {
      ...
      withdrawalNoticeText: "Za ostvarivanje prava na odustanak možete poslati e-mail na info@089bayern.com ili nazvati +90 507 192 2036 / +49 155 68855141 unutar 14 dana.",
          ...
          <section className="bg-muted/50 p-6 rounded-lg">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <div>
                ...
                <p className="text-sm text-muted-foreground">{t.phone}: +90 507 192 2036 | +49 155 68855141</p>
