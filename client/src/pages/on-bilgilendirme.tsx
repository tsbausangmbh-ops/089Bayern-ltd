...
export default function OnBilgilendirme() {
  ...
  const content = {
    tr: {
      ...
      withdrawalNoticeText: "Cayma hakkınızı kullanmak için 14 gün içinde info@089bayern.com adresine e-posta göndererek veya +90 507 183 2036 / +49 155 68855141 numarasını arayarak bildirimde bulunabilirsiniz.",
    ...
    de: {
      ...
      withdrawalNoticeText: "Um Ihr Widerrufsrecht auszuüben, können Sie innerhalb von 14 Tagen eine E-Mail an info@089bayern.com senden oder unter +90 507 183 2036 / +49 155 68855141 anrufen.",
    ...
    en: {
      ...
      withdrawalNoticeText: "To exercise your right of withdrawal, you can send an email to info@089bayern.com or call +90 507 183 2036 / +49 155 68855141 within 14 days.",
    ...
    ru: {
      ...
      withdrawalNoticeText: "Для осуществления права на отказ вы можете отправить электронное письмо на info@089bayern.com или позвонить по телефону +90 507 183 2036 / +49 155 68855141 в течение 14 дней.",
    ...
    uk: {
      ...
      withdrawalNoticeText: "Для здійснення права на відмову ви можете надіслати електронного листа на info@089bayern.com або зателефонувати за номером +90 507 183 2036 / +49 155 68855141 протягом 14 днів.",
    ...
    ar: {
      ...
      withdrawalNoticeText: "لممارسة حق الانسحاب، يمكنك إرسال بريد إلكتروني إلى info@089bayern.com أو الاتصال على +90 507 183 2036 / +49 155 68855141 خلال 14 يوماً.",
    ...
    hr: {
      ...
      section1Title: "1. Podaci o prodavatelju",
      tradeName: "Trgovački naziv",
      tradeNameValue: "089 Bayern Enerji Sistemleri Ltd. Şti.",
      address: "Adresa",
      addressValue: "Sekerhane, Halimaga Cd. Lale Tokus Plaza No 1, 07450 Alanya/Antalya, Turska",
      phone: "Telefon",
      email: "E-pošta",
      website: "Web stranica",
      tradeRegNo: "Registarski broj",
      mersisNo: "MERSIS broj",
      taxOffice: "Porezna uprava / Broj",
      toBeUpdated: "[Bit će ažurirano nakon registracije]",

      section2Title: "2. Informacije o proizvodu/usluzi",
      section2Intro: "Naša tvrtka nudi sljedeće energetske proizvode i usluge:",
      solarTitle: "Solarni energetski sustavi",
      solar1: "Ugradnja solarnih panela",
      solar2: "Inverterski sustavi",
      solar3: "Montaža i kabliranje",
      solar4: "Električno priključivanje",
      heatPumpTitle: "Sustavi toplinskih pumpi",
      heatPump1: "Ovlaštena prodaja Vaillant",
      heatPump2: "Profesionalna ugradnja",
      heatPump3: "Puštanje u rad",
      heatPump4: "Servis pod jamstvom",
      acTitle: "Klimatizacijski sustavi",
      ac1: "Ovlaštena prodaja Samsung",
      ac2: "Stambene i komercijalne klime",
      ac3: "VRF sustavi",
      ac4: "Održavanje i popravak",
      storageTitle: "Pohrana energije",
      storage1: "BYD baterijski sustavi",
      storage2: "Kućna pohrana",
      storage3: "Komercijalna pohrana",
      storage4: "Hibridni sustavi",

      section3Title: "3. Prodajna cijena i uvjeti plaćanja",
      price1: "Sve cijene su u turskim lirama (TL)",
      price2: "Status PDV-a jasno je naveden u ponudi",
      price3: "Cijene se određuju nakon besplatnog pregleda",
      price4: "Ponude vrijede 30 dana",
      paymentMethods: "Načini plaćanja:",
      payment1: "Plaćanje gotovinom",
      payment2: "Bankovni prijenos / EFT",
      payment3: "Kreditna kartica (jednokratno ili na rate)",
      payment4: "Planovi plaćanja na rate prema projektu",

      section4Title: "4. Informacije o dostavi",
      delivery1: "Vrijeme dostave varira ovisno o opsegu projekta",
      delivery2: "Za sustave koji zahtijevaju ugradnju, datum se određuje dogovorom",
      delivery3: "Naše područje usluge: Antalya, Muğla, Aydın, Denizli i okolica",
      delivery4: "Trošak dostave uključen je u projektnu ponudu",
      delivery5: "Zakonski rok dostave: najviše 30 dana",

      section5Title: "5. Pravo na odustanak",
      withdrawalInfo: "14 dana za odustanak",
      withdrawalText: "U skladu sa Zakonom br. 6502, imate pravo odustati od ugovora unutar 14 dana od potpisivanja bez navođenja razloga.",
      withdrawalExceptions: "Izuzeci od prava na odustanak:",
      exception1: "Proizvodi posebno pripremljeni prema osobnim potrebama",
      exception2: "Sustavi gdje je započela ugradnja",
      ...
      withdrawalNoticeText: "Za ostvarivanje prava na odustanak možete poslati e-mail na info@089bayern.com ili nazvati +90 507 183 2036 / +49 155 68855141 unutar 14 dana.",

      section6Title: "6. Uvjeti jamstva",
      productCol: "Proizvod",
      durationCol: "Razdoblje jamstva",
      typeCol: "Vrsta jamstva",
      solarPanels: "Solarni paneli",
      solarWarranty: "25 godina",
      performanceWarranty: "Jamstvo performansi",
      vaillantPump: "Vaillant toplinska pumpa",
      vaillantWarranty: "10 godina",
      manufacturerWarranty: "Jamstvo proizvođača",
      samsungAC: "Samsung klima uređaj",
      samsungWarranty: "5 godina",
      bydBattery: "BYD baterija",
      bydWarranty: "10 godina",
      workmanship: "Rad/Ugradnja",
      workmanshipWarranty: "2 godine",
      bayernWarranty: "089 Bayern jamstvo",

      section7Title: "7. Pritužbe i sporovi",
      section7Intro: "U slučaju pritužbi i sporova možete kontaktirati sljedeće institucije:",
      complaint1: "Povjerenstva za zaštitu potrošača (za sporove ispod određenih iznosa)",
      complaint2: "Sudovi za potrošače",
      complaint3: "Turska linija za pritužbe potrošača: 175",
      jurisdiction: "Nadležni sud i povjerenstvo: Antalya",

      section8Title: "8. Zaštita osobnih podataka",
      section8Text: "Vaši osobni podaci zaštićeni su turskim Zakonom o zaštiti osobnih podataka br. 6698 (KVKK). Za detaljne informacije pogledajte naš",
      kvkkLink: "KVKK obavijest o privatnosti",
      section8TextEnd: ".",

      contactTitle: "Kontakt informacije",
      generalContact: "Opći kontakt",
      whatsapp: "WhatsApp",
      workingHours: "Radno vrijeme",
      weekdays: "Ponedjeljak - Petak: 09:00 - 18:00",
      saturday: "Subota: 09:00 - 14:00",
      sunday: "Nedjelja: Zatvoreno",

      footer: "Ovaj obrazac za prethodnu obavijest pripremljen je u skladu s turskim Zakonom o zaštiti potrošača br. 6502 i Uredbom o ugovorima na daljinu.",
    },
  };
          ...
          <section className="bg-muted/50 p-6 rounded-lg">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <div>
                ...
                <p className="text-sm text-muted-foreground">{t.phone}: +90 507 183 2036 | +49 155 68855141</p>
