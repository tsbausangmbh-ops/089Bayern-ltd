...
export default function MesafeliSatis() {
  ...
  const content = {
    tr: {
      ...
      procedure1: "ALICI, cayma kararı hakkında SATICI'yı info@089bayern.com adresine e-posta göndererek veya +90 507 192 2036 / +49 155 68855141 numarasını arayarak bilgilendirir.",
    ...
    de: {
      ...
      procedure1: "Der KÄUFER informiert den VERKÄUFER über seinen Widerruf per E-Mail an info@089bayern.com oder telefonisch unter +90 507 192 2036 / +49 155 68855141.",
    ...
    en: {
      ...
      procedure1: "The BUYER informs the SELLER about their withdrawal decision by sending an email to info@089bayern.com or calling +90 507 192 2036 / +49 155 68855141.",
    ...
    ru: {
      ...
      procedure1: "ПОКУПАТЕЛЬ информирует ПРОДАВЦА о своём решении об отказе по электронной почте info@089bayern.com или по телефону +90 507 192 2036 / +49 155 68855141.",
    ...
    uk: {
      ...
      procedure1: "ПОКУПЕЦЬ інформує ПРОДАВЦЯ про своє рішення про відмову електронною поштою info@089bayern.com або за телефоном +90 507 192 2036 / +49 155 68855141.",
    ...
    ar: {
      ...
      procedure1: "يقوم المشتري بإبلاغ البائع بقرار الانسحاب عبر البريد الإلكتروني info@089bayern.com أو الاتصال على +90 507 192 2036 / +49 155 68855141.",
