...
export default function GunesPaneli() {
  ...
  return (
    <div className={`min-h-screen bg-background ${isRtl ? "rtl" : ""}`} dir={isRtl ? "rtl" : "ltr"} data-testid="page-gunes-paneli">
      ...
      <section className="py-16 md:py-20 bg-gradient-to-b from-amber-500/10 to-background" data-testid="section-solution">
        <div className="max-w-7xl mx-auto px-6 md:px-8">
          <div className="text-center mb-12">
      ...
      <section className="py-16 md:py-20 bg-background" data-testid="section-trust">
        <div className="max-w-7xl mx-auto px-6 md:px-8">
          <div className="text-center mb-12">
      ...
      <section className="py-16 md:py-20 bg-gradient-to-r from-amber-500/20 via-orange-500/20 to-amber-500/20" data-testid="section-urgency">
