...
const content = {
  tr: {
    ...
    badgeSub: "Tasarruf Hesaplayıcı",
    title: "Enerji Tasarrufunuzu",
    titleHighlight: "Hemen Hesaplayın",
    subtitle: "089 Bayern 4-in-1 German System ile evinizin enerji maliyetlerini ne kadar düşürebileceğinizi öğrenin. Alman mühendisliği ile %70'e varan tasarruf sağlayın.",
    ...
    howItWorksTitle: "Tasarruf Hesaplayıcı Nasıl Çalışır?",
    howItWorksSubtitle: "Sadece 3 adımda kişiselleştirilmiş tasarruf analizinizi alın",
    
    step1Title: "Evinizi Tanımlayın",
    step1Desc: "Mülk tipinizi, büyüklüğünü ve çatı alanınızı girin. Hesaplayıcımız evinize en uygun sistem boyutunu belirler.",
    
    step2Title: "Mevcut Harcamalarınızı Girin",
    step2Desc: "Aylık elektrik, ısıtma, sıcak su ve soğutma harcamalarınızı belirtin. Gerçek verilerle doğru tasarruf hesabı yapılır.",
    
    step3Title: "Tasarruf Raporunuzu Alın",
    step3Desc: "Yıllık tasarruf miktarınızı, sistem maliyetini ve geri ödeme süresini anında görün. Ücretsiz keşif randevusu alın.",
    
    whyCalculateTitle: "Neden Tasarruf Hesabı Yapmalısınız?",
    whyCalculateSubtitle: "Enerji bağımsızlığına giden yolda ilk adım: Gerçek rakamlarla planlama",
    
    reason1Title: "Gerçekçi Bütçe Planlaması",
    reason1Desc: "Hayali vaatler yerine, evinize özel hesaplanmış gerçek tasarruf rakamlarıyla yatırımınızı planlayın.",
    
    reason2Title: "Hızlı Geri Ödeme",
    reason2Desc: "Akdeniz güneşiyle ortalama 4-6 yılda yatırımınızı geri kazanın. Sonrası tamamen kar.",
    
    reason3Title: "Devlet Teşvikleri",
    reason3Desc: "Mevcut teşvik ve vergi avantajlarından yararlanarak maliyetlerinizi daha da düşürün.",
    
    reason4Title: "Çevre Dostu Yatırım",
    reason4Desc: "Yılda ortalama 15-20 ton CO2 emisyonu azaltarak geleceğe yatırım yapın.",
    
    systemsTitle: "4-in-1 German System Bileşenleri",
    systemsSubtitle: "Tek yatırımda dört farklı enerji çözümü",
    
    system1Name: "Güneş Panelleri",
    system1Desc: "Premium Alman güneş panelleri ile elektriğinizi üretin",
    
    system2Name: "Isı Pompası",
    system2Desc: "Vaillant ısı pompaları ile verimli ısıtma ve soğutma",
    
    system3Name: "Enerji Depolama",
    system3Desc: "BYD bataryalarla güneş enerjisini gece kullanın",
    
    system4Name: "Akıllı Klima",
    system4Desc: "Samsung klimalar ile konforlu yaşam alanları",
    
    guaranteeTitle: "Alman Kalite Garantisi",
    guaranteeSubtitle: "089 Bayern olarak tüm sistemlerimize kapsamlı garanti sunuyoruz",
    ...
    ctaTitle: "Tasarrufunuzu Hesaplamaya Başlayın",
    ctaSubtitle: "Aşağıdaki hesaplayıcıyı kullanarak evinize özel tasarruf analizinizi hemen alın",
    
    faqTitle: "Sık Sorulan Sorular",
    faq1Q: "Hesaplama ne kadar doğru?",
    faq1A: "Hesaplayıcımız Akdeniz iklimi ve Türkiye enerji fiyatlarına göre optimize edilmiştir. Gerçek tasarruflar yerinde keşif sonrası netleşir.",
    faq2Q: "Sistem kurulumu ne kadar sürer?",
    faq2A: "Standart bir 4-in-1 sistem kurulumu ortalama 3-5 gün sürer. Kompleks projeler daha uzun sürebilir.",
    faq3Q: "Finansman seçenekleri var mı?",
    faq3A: "Evet, banka kredisi ve taksitli ödeme seçenekleri sunuyoruz. Detaylar için ücretsiz danışmanlık alın.",
  },
  de: {
    badge: "089 Bayern German System",
    badgeSub: "Einsparungsrechner",
    title: "Berechnen Sie Ihre",
    titleHighlight: "Energieeinsparung",
    subtitle: "Erfahren Sie, wie viel Sie mit dem 089 Bayern 4-in-1 German System an Energiekosten sparen können. Bis zu 70% Einsparung durch deutsche Ingenieurskunst.",
    ...
    howItWorksTitle: "Wie funktioniert der Einsparungsrechner?",
    howItWorksSubtitle: "In nur 3 Schritten zu Ihrer personalisierten Einsparungsanalyse",
    
    step1Title: "Beschreiben Sie Ihr Zuhause",
    step1Desc: "Geben Sie Immobilientyp, Größe und Dachfläche ein. Unser Rechner ermittelt die optimale Systemgröße für Ihr Zuhause.",
    
    step2Title: "Aktuelle Ausgaben eingeben",
    step2Desc: "Geben Sie Ihre monatlichen Kosten für Strom, Heizung, Warmwasser und Kühlung an. Mit echten Daten zur genauen Berechnung.",
    
    step3Title: "Einsparungsbericht erhalten",
    step3Desc: "Sehen Sie sofort Ihre jährliche Ersparnis, Systemkosten und Amortisationszeit. Vereinbaren Sie eine kostenlose Beratung.",
    
    whyCalculateTitle: "Warum sollten Sie Ihre Einsparung berechnen?",
    whyCalculateSubtitle: "Der erste Schritt zur Energieunabhängigkeit: Planung mit echten Zahlen",
    
    reason1Title: "Realistische Budgetplanung",
    reason1Desc: "Planen Sie Ihre Investition mit echten, für Ihr Zuhause berechneten Einsparungszahlen statt leeren Versprechen.",
    
    reason2Title: "Schnelle Amortisation",
    reason2Desc: "Mit der Mittelmeersonne durchschnittlich 4-6 Jahre bis zur Amortisation. Danach reiner Gewinn.",
    
    reason3Title: "Staatliche Förderungen",
    reason3Desc: "Nutzen Sie verfügbare Förderprogramme und Steuervorteile, um Ihre Kosten weiter zu senken.",
    
    reason4Title: "Umweltfreundliche Investition",
    reason4Desc: "Investieren Sie in die Zukunft mit durchschnittlich 15-20 Tonnen CO2-Einsparung pro Jahr.",
    
    systemsTitle: "4-in-1 German System Komponenten",
    systemsSubtitle: "Vier verschiedene Energielösungen in einer Investition",
    
    system1Name: "Solarpanele",
    system1Desc: "Premium deutsche Solarpanele für eigene Stromerzeugung",
    
    system2Name: "Wärmepumpe",
    system2Desc: "Vaillant Wärmepumpen für effizientes Heizen und Kühlen",
    
    system3Name: "Energiespeicher",
    system3Desc: "BYD Batterien zur Nutzung von Solarstrom bei Nacht",
    
    system4Name: "Smart-Klima",
    system4Desc: "Samsung Klimaanlagen für komfortable Wohnräume",
    
    guaranteeTitle: "Deutsche Qualitätsgarantie",
    guaranteeSubtitle: "Als 089 Bayern bieten wir umfassende Garantien für alle unsere Systeme",
    ...
    ctaTitle: "Berechnen Sie Ihre Einsparung",
    ctaSubtitle: "Nutzen Sie den Rechner unten für Ihre personalisierte Einsparungsanalyse",
    
    faqTitle: "Häufig gestellte Fragen",
    faq1Q: "Wie genau ist die Berechnung?",
    faq1A: "Unser Rechner ist für das Mittelmeerklima und türkische Energiepreise optimiert. Genaue Einsparungen werden nach Vor-Ort-Besichtigung ermittelt.",
    faq2Q: "Wie lange dauert die Systeminstallation?",
    faq2A: "Eine Standard 4-in-1 Systeminstallation dauert durchschnittlich 3-5 Tage. Komplexe Projekte können länger dauern.",
    faq3Q: "Gibt es Finanzierungsoptionen?",
    faq3A: "Ja, wir bieten Bankkredit und Ratenzahlung an. Für Details vereinbaren Sie eine kostenlose Beratung.",
  },
  en: {
    badge: "089 Bayern German System",
