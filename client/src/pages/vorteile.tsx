...
export default function Vorteile() {
  ...
  const content = {
    tr: {
      badge: "4 in 1 Enerji Sistemi",
      title: "10 Ay Boyunca",
      titleHighlight: "Ücretsiz Enerji",
      subtitle: "Wärmepompa, güneş paneli, enerji depolama ve sıcak su deposu - hepsi tek bir sistemde. Antalya'nın 300+ güneşli günü sayesinde yılın 10 ayı boyunca elektrik ve ısınma masraflarınız neredeyse sıfır.",
      ...
      systemTitle: "4 in 1 Entegre Sistem",
      systemSubtitle: "Dört farklı teknoloji, tek akıllı sistem",
      ...
      comparisonTitle: "Geleneksel vs. 4 in 1 Sistem",
      traditional: "Geleneksel Sistem",
      integrated: "4 in 1 Sistem",
    ...
    de: {
      badge: "4 in 1 Energiesystem",
      title: "10 Monate",
      titleHighlight: "Kostenlose Energie",
      subtitle: "Wärmepumpe, Solarpanels, Energiespeicher und Warmwasserspeicher - alles in einem System. Dank der 300+ Sonnentage in Antalya sind Ihre Strom- und Heizkosten 10 Monate im Jahr praktisch null.",
      ...
      systemTitle: "4 in 1 Integriertes System",
      systemSubtitle: "Vier verschiedene Technologien, ein intelligentes System",
      ...
      comparisonTitle: "Traditionell vs. 4 in 1 System",
      traditional: "Traditionelles System",
      integrated: "4 in 1 System",
    ...
    en: {
      badge: "4 in 1 Energy System",
      title: "10 Months of",
      titleHighlight: "Free Energy",
      subtitle: "Heat pump, solar panels, energy storage and hot water tank - all in one system. Thanks to 300+ sunny days in Antalya, your electricity and heating costs are virtually zero for 10 months a year.",
      ...
      systemTitle: "4 in 1 Integrated System",
      systemSubtitle: "Four different technologies, one intelligent system",
      ...
      comparisonTitle: "Traditional vs. 4 in 1 System",
    ...
    ru: {
      badge: "4 в 1 Энергосистема",
      title: "10 Месяцев",
      titleHighlight: "Бесплатной Энергии",
      subtitle: "Тепловой насос, солнечные панели, накопитель энергии и бойлер - всё в одной системе. Благодаря 300+ солнечным дням в Анталии ваши расходы на электричество и отопление практически нулевые 10 месяцев в году.",
      ...
      systemTitle: "4 в 1 Интегрированная Система",
      systemSubtitle: "Четыре разные технологии, одна умная система",
      ...
      comparisonTitle: "Традиционная vs. 4 в 1 Система",
      traditional: "Традиционная Система",
      integrated: "4 в 1 Система",
    ...
    uk: {
      badge: "4 в 1 Енергосистема",
      title: "10 Місяців",
      titleHighlight: "Безкоштовної Енергії",
      subtitle: "Тепловий насос, сонячні панелі, накопичувач енергії та бойлер - все в одній системі. Завдяки 300+ сонячним дням в Анталії ваші витрати на електрику та опалення практично нульові 10 місяців на рік.",
      ...
      systemTitle: "4 в 1 Інтегрована Система",
      systemSubtitle: "Чотири різні технології, одна розумна система",
      ...
      comparisonTitle: "Традиційна vs. 4 в 1 Система",
    ...
    ar: {
      ...
      comparisonTitle: "التقليدي مقابل نظام 4 في 1",
      traditional: "النظام التقليدي",
      integrated: "نظام 4 في 1",
  ...
  return (
    <div className="min-h-screen bg-background" data-testid="page-vorteile">
      ...
      <section className="py-6 md:py-8 bg-muted/30" data-testid="section-stats">
      ...
      <section className="py-6 md:py-8 bg-background" data-testid="section-free-energy">
        <div className="max-w-7xl mx-auto px-6 md:px-8">
          <div className="text-center mb-8">
      ...
      <section className="py-6 md:py-8 bg-muted/30" data-testid="section-4in1-system">
        <div className="max-w-7xl mx-auto px-6 md:px-8">
          <div className="text-center mb-8">
            <Badge variant="secondary" className="mb-4">
      ...
      <section className="py-6 md:py-8 bg-background" data-testid="section-expansions">
        <div className="max-w-7xl mx-auto px-6 md:px-8">
          <div className="text-center mb-8">
            <Badge variant="secondary" className="mb-4">
      ...
      <section className="py-6 md:py-8 bg-muted/30" data-testid="section-comparison">
      ...
      <section className="py-6 md:py-8 bg-background" data-testid="section-cta-bottom">
