      ...
      <section className="relative min-h-[80vh] flex items-center" data-testid="section-hero">
        ...
        <div className="relative max-w-7xl mx-auto px-6 md:px-8 py-20">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <Button size="lg" variant="outline" className="border-green-400/50 text-white bg-green-500/20 backdrop-blur-sm" onClick={() => window.open("https://wa.me/905071832036", "_blank")} data-testid="button-hero-whatsapp">
              WhatsApp
            </Button>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="rounded-xl overflow-hidden shadow-xl">
              <img 
                src={teamWorkImage} 
                alt="089 Bayern kurulum ekibi Alanya'da çalışıyor" 
            ...
            <div className="rounded-xl overflow-hidden shadow-xl">
              <img 
                src={deliveryImage} 
                alt="Profesyonel ekipman teslimi" 
                className="w-full h-80 md:h-96 object-cover hover:scale-105 transition-transform duration-500"
