...
export default function SavingsCalculator({ onComplete }: SavingsCalculatorProps) {
  ...
  if (showResults) {
    return (
      <section id="calculator" className="py-10 md:py-12 bg-background relative overflow-hidden" data-testid="section-calculator">
  ...
  return (
    <section id="calculator" className="py-10 md:py-12 bg-gradient-to-b from-card/30 to-background relative overflow-hidden" data-testid="section-calculator">
