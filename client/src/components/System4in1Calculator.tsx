...
const translations: Record<string, {
  ...
  de: {
    ...
    disclaimer: "* Komplettpreis inkl. PV, Wärmepumpe, Kühlung, Warmwasser & Speicher. Installation in Antalya/Alanya.",
  ...
  tr: {
    ...
    tonsPerYear: "Ton/Yıl",
    disclaimer: "* PV, ısı pompası, soğutma, sıcak su ve batarya dahil komple fiyat. Antalya/Alanya kurulumu.",
  ...
  en: {
    ...
    disclaimer: "* Complete price incl. PV, heat pump, cooling, hot water & battery. Installation in Antalya/Alanya.",
  ...
  ru: {
    ...
    disclaimer: "* Полная цена вкл. PV, тепловой насос, охлаждение, горячую воду и аккумулятор. Установка в Анталии/Аланье.",
  ...
  uk: {
    ...
    disclaimer: "* Повна ціна вкл. PV, тепловий насос, охолодження, гарячу воду та акумулятор. Встановлення в Анталії/Аланії.",
  ...
  ar: {
    ...
    co2Saved: "توفير CO₂",
    tonsPerYear: "طن/سنة",
    disclaimer: "* السعر الكامل يشمل PV ومضخة حرارية وتبريد وماء ساخن وبطارية. التركيب في أنطاليا/ألانيا.",
  ...
  hr: {
    ...
    disclaimer: "* Kompletna cijena uklj. PV, dizalicu topline, hlađenje, toplu vodu i bateriju. Ugradnja u Antaliji/Alanji.",
