...
const content = {
  de: {
    ...
    locationNote: "Unser Standort ist die Türkei - rufen Sie uns an!",
  ...
  tr: {
    ...
    locationNote: "Merkezimiz Türkiye'de - bizi arayın!",
  ...
  en: {
    ...
    locationNote: "We are located in Turkey - call us!",
  ...
  ru: {
    ...
    locationNote: "Наш офис в Турции - звоните нам!",
  ...
  uk: {
    ...
    locationNote: "Наш офіс у Туреччині - телефонуйте нам!",
  ...
  ar: {
    ...
    locationNote: "مقرنا في تركيا - اتصل بنا!",
  ...
  hr: {
    ...
    locationNote: "Naše sjedište je u Turskoj - nazovite nas!",
